...
const TopFoodSec = () => {
    return (
        <>
          ...
          <h2 className="my-10 text-center text-5xl font-bold  bg-gradient-to-r from-red-500 via-orange-500 to-yellow-200  text-transparent   bg-clip-text" data-aos="fade-up"
