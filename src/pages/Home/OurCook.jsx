...
const OurCook = () => {
  ...
  <div className="w-52 rounded-full">
    <img src="https://i.ibb.co/ZxDcBbC/chef-with-thumb-up-white-background.jpg" />

  </div>
</div>
<div className="avatar">
  <div className="w-52 rounded-full">
    <img src="https://i.ibb.co/8zRX0yw/portrait-smiling-chef-uniform.jpg" />
  </div>
</div>
<div className="avatar">
  <div className="w-52 rounded-full">
    <img src="https://i.ibb.co/1YVdp8Z/young-confident-afro-american-cook-chef-uniform-crosses-arms-keeps-hand-open-isolated-green-backgrou.jpg" />
  </div>
</div>
<div className="avatar">
  <div className="w-52 rounded-full">
    <img src="https://i.ibb.co/vBnbfK5/confident-young-male-cook-wearing-chef-uniform-crossing-hands-points-finger-side-isolated-green-wall.jpg" />
  </div>
</div>
